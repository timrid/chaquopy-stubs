...
class SharedFlowImpl(kotlinx.coroutines.flow.internal.AbstractSharedFlow[SharedFlowSlot], MutableSharedFlow[_SharedFlowImpl__T], CancellableFlow[_SharedFlowImpl__T], kotlinx.coroutines.flow.internal.FusibleFlow[_SharedFlowImpl__T], typing.Generic[_SharedFlowImpl__T]):
    ...
    def collect(self, collector: FlowCollector[_SharedFlowImpl__T], completion: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
...
class SharingStartedKt(java.lang.Object):
    @staticmethod
    def WhileSubscribed-9tZugJw(this_WhileSubscribed: SharingStarted.Companion, stopTimeout: float | java.jdouble | java.lang.Double, replayExpiration: float | java.jdouble | java.lang.Double, /) -> SharingStarted: ...
