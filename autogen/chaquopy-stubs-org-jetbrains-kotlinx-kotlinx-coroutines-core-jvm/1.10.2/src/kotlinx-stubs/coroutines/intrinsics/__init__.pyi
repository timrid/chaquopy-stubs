...
class UndispatchedKt(java.lang.Object):
    _startCoroutineUndispatched__R = typing.TypeVar('_startCoroutineUndispatched__R')  # <R>
    _startCoroutineUndispatched__T = typing.TypeVar('_startCoroutineUndispatched__T')  # <T>
    @staticmethod
    def startCoroutineUndispatched(this_startCoroutineUndispatched: kotlin.jvm.functions.Function2[_startCoroutineUndispatched__R, kotlin.coroutines.Continuation[_startCoroutineUndispatched__T], java.lang.Object], receiver: _startCoroutineUndispatched__R, completion: kotlin.coroutines.Continuation[_startCoroutineUndispatched__T], /) -> None: ...
