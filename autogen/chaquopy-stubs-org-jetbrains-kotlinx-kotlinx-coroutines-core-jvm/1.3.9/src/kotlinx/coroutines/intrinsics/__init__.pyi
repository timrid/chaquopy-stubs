...
class UndispatchedKt(java.lang.Object):
    ...
    _startCoroutineUnintercepted_0__T = typing.TypeVar('_startCoroutineUnintercepted_0__T')  # <T>
    _startCoroutineUnintercepted_1__R = typing.TypeVar('_startCoroutineUnintercepted_1__R')  # <R>
    _startCoroutineUnintercepted_1__T = typing.TypeVar('_startCoroutineUnintercepted_1__T')  # <T>
    @typing.overload
    @staticmethod
    def startCoroutineUnintercepted(this_startCoroutineUnintercepted: kotlin.jvm.functions.Function1[kotlin.coroutines.Continuation[_startCoroutineUnintercepted_0__T], java.lang.Object], completion: kotlin.coroutines.Continuation[_startCoroutineUnintercepted_0__T], /) -> None: ...
    @typing.overload
    @staticmethod
    def startCoroutineUnintercepted(this_startCoroutineUnintercepted: kotlin.jvm.functions.Function2[_startCoroutineUnintercepted_1__R, kotlin.coroutines.Continuation[_startCoroutineUnintercepted_1__T], java.lang.Object], receiver: _startCoroutineUnintercepted_1__R, completion: kotlin.coroutines.Continuation[_startCoroutineUnintercepted_1__T], /) -> None: ...
