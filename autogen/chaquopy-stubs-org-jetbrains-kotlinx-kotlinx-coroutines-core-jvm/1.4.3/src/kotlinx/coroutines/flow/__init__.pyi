...
class FlowKt(java.lang.Object):
    ...
    @staticmethod
    def debounce-HG0u8IE(this_debounce: Flow[_debounce-HG0u8IE__T], timeout: float | java.jdouble | java.lang.Double, /) -> Flow[_debounce-HG0u8IE__T]: ...
    ...
    @staticmethod
    def sample-HG0u8IE(this_sample: Flow[_sample-HG0u8IE__T], period: float | java.jdouble | java.lang.Double, /) -> Flow[_sample-HG0u8IE__T]: ...
...
class ReadonlySharedFlow(SharedFlow[_ReadonlySharedFlow__T], CancellableFlow[_ReadonlySharedFlow__T], kotlinx.coroutines.flow.internal.FusibleFlow[_ReadonlySharedFlow__T], typing.Generic[_ReadonlySharedFlow__T]):
    def __init__(self, flow: SharedFlow[_ReadonlySharedFlow__T], /) -> None: ...
    def collect(self, collector: FlowCollector[_ReadonlySharedFlow__T], arg2: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
...
class ReadonlyStateFlow(StateFlow[_ReadonlyStateFlow__T], CancellableFlow[_ReadonlyStateFlow__T], kotlinx.coroutines.flow.internal.FusibleFlow[_ReadonlyStateFlow__T], typing.Generic[_ReadonlyStateFlow__T]):
    def __init__(self, flow: StateFlow[_ReadonlyStateFlow__T], /) -> None: ...
    def collect(self, collector: FlowCollector[_ReadonlyStateFlow__T], arg2: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
...
class SharingCommand(java.lang.Enum[SharingCommand]):
    ...
    @staticmethod
    def valueOf(arg1: str | java.lang.String, /) -> SharingCommand: ...
    @staticmethod
...
class SharingStartedKt(java.lang.Object):
    @staticmethod
    def WhileSubscribed-5qebJ5I(this_WhileSubscribed: SharingStarted.Companion, stopTimeout: float | java.jdouble | java.lang.Double, replayExpiration: float | java.jdouble | java.lang.Double, /) -> SharingStarted: ...
...
class SubscribedFlowCollector(FlowCollector[_SubscribedFlowCollector__T], typing.Generic[_SubscribedFlowCollector__T]):
    ...
    def emit(self, value: _SubscribedFlowCollector__T, arg2: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
