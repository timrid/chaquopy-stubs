...
class Duration(java.lang.Comparable[Duration], java.io.Serializable, java.time.temporal.TemporalAmount):
...
class Instant(java.lang.Comparable[Instant], java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
...
class LocalDate(java.time.chrono.ChronoLocalDate, java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
...
class LocalDateTime(java.time.chrono.ChronoLocalDateTime[LocalDate], java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
...
class LocalTime(java.lang.Comparable[LocalTime], java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
...
class MonthDay(java.lang.Comparable[MonthDay], java.io.Serializable, java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster):
    def adjustInto(self, temporal: java.time.temporal.Temporal, /) -> java.time.temporal.Temporal: ...
...
class OffsetDateTime(java.lang.Comparable[OffsetDateTime], java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
...
class OffsetTime(java.lang.Comparable[OffsetTime], java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
...
class Year(java.lang.Comparable[Year], java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
...
class YearMonth(java.lang.Comparable[YearMonth], java.io.Serializable, java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster):
    def adjustInto(self, temporal: java.time.temporal.Temporal, /) -> java.time.temporal.Temporal: ...
...
class ZoneOffset(ZoneId, java.lang.Comparable[ZoneOffset], java.io.Serializable, java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster):
...
class ZonedDateTime(java.time.chrono.ChronoZonedDateTime[LocalDate], java.io.Serializable, java.time.temporal.Temporal):
    def equals(self, obj: java.lang.Object | int | bool | float | str, /) -> bool: ...
    def format(self, formatter: java.time.format.DateTimeFormatter, /) -> str: ...
    @staticmethod
