...
class BatteryManager(java.lang.Object):
    ...
    BATTERY_CAPACITY_LEVEL_CRITICAL: typing.ClassVar[int] = ...
    BATTERY_CAPACITY_LEVEL_FULL: typing.ClassVar[int] = ...
    BATTERY_CAPACITY_LEVEL_HIGH: typing.ClassVar[int] = ...
    BATTERY_CAPACITY_LEVEL_LOW: typing.ClassVar[int] = ...
    BATTERY_CAPACITY_LEVEL_NORMAL: typing.ClassVar[int] = ...
    BATTERY_CAPACITY_LEVEL_UNKNOWN: typing.ClassVar[int] = ...
    BATTERY_CAPACITY_LEVEL_UNSUPPORTED: typing.ClassVar[int] = ...
    ...
    EXTRA_CAPACITY_LEVEL: typing.ClassVar[str] = ...
...
class Build(java.lang.Object):
    ...
    @staticmethod
    def getMajorSdkVersion(sdkIntFull: int | java.jint | java.lang.Integer, /) -> int: ...
    @staticmethod
    def getMinorSdkVersion(sdkIntFull: int | java.jint | java.lang.Integer, /) -> int: ...
    @staticmethod
    def getRadioVersion() -> str: ...
    @staticmethod
    def getSerial() -> str: ...

    class VERSION_CODES_FULL(java.lang.Object):
        BAKLAVA: typing.ClassVar[int] = ...
    ...
    class VERSION(java.lang.Object):
        ...
        SDK_INT_FULL: typing.ClassVar[int] = ...
...
class CpuHeadroomParams(java.lang.Object):
    CPU_HEADROOM_CALCULATION_TYPE_AVERAGE: typing.ClassVar[int] = ...
    CPU_HEADROOM_CALCULATION_TYPE_MIN: typing.ClassVar[int] = ...
    def equals(self, o: java.lang.Object | int | bool | float | str, /) -> bool: ...
    def getCalculationType(self) -> int: ...
    def getCalculationWindowMillis(self) -> int: ...
    def getTids(self) -> java.chaquopy.JavaArrayJInt: ...
    def hashCode(self) -> int: ...
    def toBuilder(self) -> CpuHeadroomParams.Builder: ...
    def toString(self) -> str: ...
    ...
    class Builder(java.lang.Object):
        ...
        def __init__(self) -> None: ...
        @typing.overload
        def __init__(self, params: CpuHeadroomParams, /) -> None: ...
        def build(self) -> CpuHeadroomParams: ...
        def setCalculationType(self, calculationType: int | java.jint | java.lang.Integer, /) -> CpuHeadroomParams.Builder: ...
        def setCalculationWindowMillis(self, windowMillis: int | java.jint | java.lang.Integer, /) -> CpuHeadroomParams.Builder: ...
        def setTids(self, *tids: java.jint) -> CpuHeadroomParams.Builder: ...
...
class DropBoxManager(java.lang.Object):
    ...
    class Entry(java.io.Closeable, Parcelable):
...
class GpuHeadroomParams(java.lang.Object):
    GPU_HEADROOM_CALCULATION_TYPE_AVERAGE: typing.ClassVar[int] = ...
    GPU_HEADROOM_CALCULATION_TYPE_MIN: typing.ClassVar[int] = ...
    GPU_HEADROOM_CALCULATION_WINDOW_MILLIS_MAX: typing.ClassVar[int] = ...
    GPU_HEADROOM_CALCULATION_WINDOW_MILLIS_MIN: typing.ClassVar[int] = ...
    def equals(self, o: java.lang.Object | int | bool | float | str, /) -> bool: ...
    def getCalculationType(self) -> int: ...
    def getCalculationWindowMillis(self) -> int: ...
    def hashCode(self) -> int: ...
    ...
    class Builder(java.lang.Object):
        ...
        def __init__(self) -> None: ...
        @typing.overload
        def __init__(self, params: GpuHeadroomParams, /) -> None: ...
        def build(self) -> GpuHeadroomParams: ...
        def setCalculationType(self, calculationType: int | java.jint | java.lang.Integer, /) -> GpuHeadroomParams.Builder: ...
        def setCalculationWindowMillis(self, windowMillis: int | java.jint | java.lang.Integer, /) -> GpuHeadroomParams.Builder: ...
...
class IBinder(java.lang.Object):
    ...
    def addFrozenStateChangeCallback(self, executor: java.util.concurrent.Executor, callback: IBinder.FrozenStateChangeCallback, /) -> None: ...
    ...
    def removeFrozenStateChangeCallback(self, callback: IBinder.FrozenStateChangeCallback, /) -> bool: ...
    ...
    class FrozenStateChangeCallback(java.lang.Object):
        STATE_FROZEN: typing.ClassVar[int] = ...
        STATE_UNFROZEN: typing.ClassVar[int] = ...
        def onFrozenStateChanged(self, arg1: IBinder, arg2: int | java.jint | java.lang.Integer, /) -> None: ...
...
class Parcel(java.lang.Object):
    ...
    @typing.overload
    def createFixedArray(self, cls: typing.Type[_createFixedArray_0__T], /, *dimensions: java.jint) -> _createFixedArray_0__T | None: ...
    @typing.overload
    def createFixedArray(self, cls: typing.Type[_createFixedArray_1__T], c: Parcelable.Creator[java.lang.Object], /, *dimensions: java.jint) -> _createFixedArray_1__T | None: ...
    @typing.overload
    def createFixedArray(self, cls: typing.Type[_createFixedArray_2__T], asInterface: java.util.function.Function[IBinder, java.lang.Object], /, *dimensions: java.jint) -> _createFixedArray_2__T | None: ...
    ...
    def writeFixedArray(self, val: java.lang.Object, parcelableFlags: int | java.jint | java.lang.Integer, /, *dimensions: java.jint) -> None: ...
...
class ParcelFileDescriptor(java.io.Closeable, Parcelable):
...
class PowerManager(java.lang.Object):
    ...
    @typing.overload
    def addThermalHeadroomListener(self, listener: PowerManager.OnThermalHeadroomChangedListener, /) -> None: ...
    @typing.overload
    def addThermalHeadroomListener(self, executor: java.util.concurrent.Executor, listener: PowerManager.OnThermalHeadroomChangedListener, /) -> None: ...
    @typing.overload
    ...
    def removeThermalHeadroomListener(self, listener: PowerManager.OnThermalHeadroomChangedListener, /) -> None: ...
    ...
    class OnThermalHeadroomChangedListener(java.lang.Object):
        def onThermalHeadroomChanged(self, arg1: float | java.jfloat | java.lang.Float, arg2: float | java.jfloat | java.lang.Float, arg3: int | java.jint | java.lang.Integer, arg4: java.util.Map[java.lang.Integer, java.lang.Float], /) -> None: ...
...
class ProfilingManager(java.lang.Object):
    ...
    def addProfilingTriggers(self, triggers: java.util.List[ProfilingTrigger], /) -> None: ...
    ...
    def removeProfilingTriggersByType(self, triggers: java.chaquopy.JavaArrayJInt, /) -> None: ...
...
class ProfilingTrigger(java.lang.Object):
    TRIGGER_TYPE_ANR: typing.ClassVar[int] = ...
    TRIGGER_TYPE_APP_FULLY_DRAWN: typing.ClassVar[int] = ...
    TRIGGER_TYPE_NONE: typing.ClassVar[int] = ...
    def getRateLimitingPeriodHours(self) -> int: ...
    def getTriggerType(self) -> int: ...

    class Builder(java.lang.Object):
        def __init__(self, triggerType: int | java.jint | java.lang.Integer, /) -> None: ...
        def build(self) -> ProfilingTrigger: ...
        def setRateLimitingPeriodHours(self, rateLimitingPeriodHours: int | java.jint | java.lang.Integer, /) -> ProfilingTrigger.Builder: ...
...
_RemoteCallbackList__Builder__E = typing.TypeVar('_RemoteCallbackList__Builder__E')  # <E>

_RemoteCallbackList__Builder__InterfaceDiedCallback__E = typing.TypeVar('_RemoteCallbackList__Builder__InterfaceDiedCallback__E')  # <E>
class RemoteCallbackList(java.lang.Object, typing.Generic[_RemoteCallbackList__E]):
    FROZEN_CALLEE_POLICY_DROP: typing.ClassVar[int] = ...
    FROZEN_CALLEE_POLICY_ENQUEUE_ALL: typing.ClassVar[int] = ...
    FROZEN_CALLEE_POLICY_ENQUEUE_MOST_RECENT: typing.ClassVar[int] = ...
    FROZEN_CALLEE_POLICY_UNSET: typing.ClassVar[int] = ...
    def __init__(self) -> None: ...
    def beginBroadcast(self) -> int: ...
    def broadcast(self, callback: java.util.function.Consumer[_RemoteCallbackList__E], /) -> None: ...
    ...
    def kill(self) -> None: ...
    @typing.overload
    def onCallbackDied(self, callbackInterface: _RemoteCallbackList__E, /) -> None: ...
    @typing.overload
    def onCallbackDied(self, callbackInterface: _RemoteCallbackList__E, cookie: java.lang.Object | int | bool | float | str, /) -> None: ...
    @typing.overload
    def register(self, callbackInterface: _RemoteCallbackList__E, /) -> bool: ...
    @typing.overload
    def register(self, callbackInterface: _RemoteCallbackList__E, cookie: java.lang.Object | int | bool | float | str, /) -> bool: ...
    def unregister(self, callbackInterface: _RemoteCallbackList__E, /) -> bool: ...
    class Builder(java.lang.Object, typing.Generic[_RemoteCallbackList__Builder__E]):
        def __init__(self, frozenCalleePolicy: int | java.jint | java.lang.Integer, /) -> None: ...
        def build(self) -> RemoteCallbackList[_RemoteCallbackList__Builder__E]: ...
        def setExecutor(self, executor: java.util.concurrent.Executor, /) -> RemoteCallbackList.Builder: ...
        def setInterfaceDiedCallback(self, callback: RemoteCallbackList.Builder.InterfaceDiedCallback[_RemoteCallbackList__Builder__E], /) -> RemoteCallbackList.Builder: ...
        def setMaxQueueSize(self, maxQueueSize: int | java.jint | java.lang.Integer, /) -> RemoteCallbackList.Builder: ...
        class InterfaceDiedCallback(java.lang.Object, typing.Generic[_RemoteCallbackList__Builder__InterfaceDiedCallback__E]):
            def onInterfaceDied(self, arg1: RemoteCallbackList[_RemoteCallbackList__Builder__InterfaceDiedCallback__E], arg2: _RemoteCallbackList__Builder__InterfaceDiedCallback__E, arg3: java.lang.Object | int | bool | float | str, /) -> None: ...
...
class SharedMemory(java.io.Closeable, Parcelable):
...
class StrictMode(java.lang.Object):
    ...
    class VmPolicy(java.lang.Object):
        ...
        class Builder(java.lang.Object):
            ...
            def detectBlockedBackgroundActivityLaunch(self) -> StrictMode.VmPolicy.Builder: ...
            ...
            def ignoreBlockedBackgroundActivityLaunch(self) -> StrictMode.VmPolicy.Builder: ...
...
class UserManager(java.lang.Object):
    ...
    DISALLOW_CHANGE_NEAR_FIELD_COMMUNICATION_RADIO: typing.ClassVar[str] = ...
    ...
    DISALLOW_THREAD_NETWORK: typing.ClassVar[str] = ...
...
class VibrationEffect(Parcelable):
    ...
    @typing.overload
    @staticmethod
    def createRepeatingEffect(effect: VibrationEffect, /) -> VibrationEffect: ...
    @typing.overload
    @staticmethod
    def createRepeatingEffect(preamble: VibrationEffect, repeatingEffect: VibrationEffect, /) -> VibrationEffect: ...
    @typing.overload
    @staticmethod
    ...
    class WaveformEnvelopeBuilder(java.lang.Object):
        def __init__(self) -> None: ...
        def addControlPoint(self, amplitude: float | java.jfloat | java.lang.Float, frequencyHz: float | java.jfloat | java.lang.Float, durationMillis: int | java.jlong | java.lang.Long, /) -> VibrationEffect.WaveformEnvelopeBuilder: ...
        def build(self) -> VibrationEffect: ...
        def setInitialFrequencyHz(self, initialFrequencyHz: float | java.jfloat | java.lang.Float, /) -> VibrationEffect.WaveformEnvelopeBuilder: ...

    class Composition(java.lang.Object):
        DELAY_TYPE_PAUSE: typing.ClassVar[int] = ...
        DELAY_TYPE_RELATIVE_START_OFFSET: typing.ClassVar[int] = ...
        ...
        @typing.overload
        def addPrimitive(self, primitiveId: int | java.jint | java.lang.Integer, scale: float | java.jfloat | java.lang.Float, delay: int | java.jint | java.lang.Integer, delayType: int | java.jint | java.lang.Integer, /) -> VibrationEffect.Composition: ...
        def compose(self) -> VibrationEffect: ...

    class BasicEnvelopeBuilder(java.lang.Object):
        def __init__(self) -> None: ...
        def addControlPoint(self, intensity: float | java.jfloat | java.lang.Float, sharpness: float | java.jfloat | java.lang.Float, durationMillis: int | java.jlong | java.lang.Long, /) -> VibrationEffect.BasicEnvelopeBuilder: ...
        def build(self) -> VibrationEffect: ...
        def setInitialSharpness(self, initialSharpness: float | java.jfloat | java.lang.Float, /) -> VibrationEffect.BasicEnvelopeBuilder: ...
...
class Vibrator(java.lang.Object):
    ...
    def areAllEffectsSupported(self, *effectIds: java.jint) -> int: ...
    def areAllPrimitivesSupported(self, *primitiveIds: java.jint) -> bool: ...
    def areEffectsSupported(self, *effectIds: java.jint) -> java.chaquopy.JavaArrayJInt: ...
    def areEnvelopeEffectsSupported(self) -> bool: ...
    def arePrimitivesSupported(self, *primitiveIds: java.jint) -> java.chaquopy.JavaArrayJBoolean: ...
    def cancel(self) -> None: ...
    def getEnvelopeEffectInfo(self) -> android.os.vibrator.VibratorEnvelopeEffectInfo: ...
    def getFrequencyProfile(self) -> android.os.vibrator.VibratorFrequencyProfile: ...
    def getId(self) -> int: ...
    def getPrimitiveDurations(self, *primitiveIds: java.jint) -> java.chaquopy.JavaArrayJInt: ...
