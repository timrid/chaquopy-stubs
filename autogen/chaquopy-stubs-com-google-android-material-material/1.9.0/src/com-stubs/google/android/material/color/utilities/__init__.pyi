...
class DynamicColor(java.lang.Object):
    hue: java.util.function.Function[DynamicScheme, java.lang.Double] = ...
    chroma: java.util.function.Function[DynamicScheme, java.lang.Double] = ...
    ...
    toneMinContrast: java.util.function.Function[DynamicScheme, java.lang.Double] = ...
    toneMaxContrast: java.util.function.Function[DynamicScheme, java.lang.Double] = ...
    toneDeltaConstraint: java.util.function.Function[DynamicScheme, ToneDeltaConstraint] = ...
    def __init__(self, hue: java.util.function.Function[DynamicScheme, java.lang.Double], chroma: java.util.function.Function[DynamicScheme, java.lang.Double], tone: java.util.function.Function[DynamicScheme, java.lang.Double], opacity: java.util.function.Function[DynamicScheme, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], toneMinContrast: java.util.function.Function[DynamicScheme, java.lang.Double], toneMaxContrast: java.util.function.Function[DynamicScheme, java.lang.Double], toneDeltaConstraint: java.util.function.Function[DynamicScheme, ToneDeltaConstraint], /) -> None: ...
    @staticmethod
    def calculateDynamicTone(scheme: DynamicScheme, toneStandard: java.util.function.Function[DynamicScheme, java.lang.Double], toneToJudge: java.util.function.Function[DynamicColor, java.lang.Double], desiredTone: java.util.function.BiFunction[java.lang.Double, java.lang.Double, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], toneDeltaConstraint: java.util.function.Function[DynamicScheme, ToneDeltaConstraint], minRatio: java.util.function.Function[java.lang.Double, java.lang.Double], maxRatio: java.util.function.Function[java.lang.Double, java.lang.Double], /) -> float: ...
    @staticmethod
    def contrastingTone(bgTone: float | java.jdouble | java.lang.Double, ratio: float | java.jdouble | java.lang.Double, /) -> float: ...
    @staticmethod
    def enableLightForeground(tone: float | java.jdouble | java.lang.Double, /) -> float: ...
    @typing.overload
    @staticmethod
    def fromArgb(argb: int | java.jint | java.lang.Integer, /) -> DynamicColor: ...
    @typing.overload
    @staticmethod
    def fromArgb(argb: int | java.jint | java.lang.Integer, tone: java.util.function.Function[DynamicScheme, java.lang.Double], /) -> DynamicColor: ...
    @typing.overload
    @staticmethod
    def fromArgb(argb: int | java.jint | java.lang.Integer, tone: java.util.function.Function[DynamicScheme, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], /) -> DynamicColor: ...
    @typing.overload
    @staticmethod
    def fromArgb(argb: int | java.jint | java.lang.Integer, tone: java.util.function.Function[DynamicScheme, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], toneDeltaConstraint: java.util.function.Function[DynamicScheme, ToneDeltaConstraint], /) -> DynamicColor: ...
    @typing.overload
    @staticmethod
    def fromPalette(palette: java.util.function.Function[DynamicScheme, TonalPalette], tone: java.util.function.Function[DynamicScheme, java.lang.Double], /) -> DynamicColor: ...
    @typing.overload
    @staticmethod
    def fromPalette(palette: java.util.function.Function[DynamicScheme, TonalPalette], tone: java.util.function.Function[DynamicScheme, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], /) -> DynamicColor: ...
    @typing.overload
    @staticmethod
    def fromPalette(palette: java.util.function.Function[DynamicScheme, TonalPalette], tone: java.util.function.Function[DynamicScheme, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], toneDeltaConstraint: java.util.function.Function[DynamicScheme, ToneDeltaConstraint], /) -> DynamicColor: ...
    ...
    @staticmethod
    def toneMaxContrastDefault(tone: java.util.function.Function[DynamicScheme, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], scheme: DynamicScheme, toneDeltaConstraint: java.util.function.Function[DynamicScheme, ToneDeltaConstraint], /) -> float: ...
    @staticmethod
    def toneMinContrastDefault(tone: java.util.function.Function[DynamicScheme, java.lang.Double], background: java.util.function.Function[DynamicScheme, DynamicColor], scheme: DynamicScheme, toneDeltaConstraint: java.util.function.Function[DynamicScheme, ToneDeltaConstraint], /) -> float: ...
    @staticmethod
...
class MaterialDynamicColors(java.lang.Object):
    background: typing.ClassVar[DynamicColor] = ...
    onBackground: typing.ClassVar[DynamicColor] = ...
    surface: typing.ClassVar[DynamicColor] = ...
    surfaceInverse: typing.ClassVar[DynamicColor] = ...
    surfaceBright: typing.ClassVar[DynamicColor] = ...
    surfaceDim: typing.ClassVar[DynamicColor] = ...
    surfaceSub2: typing.ClassVar[DynamicColor] = ...
    surfaceSub1: typing.ClassVar[DynamicColor] = ...
    surfaceContainer: typing.ClassVar[DynamicColor] = ...
    surfaceAdd1: typing.ClassVar[DynamicColor] = ...
    surfaceAdd2: typing.ClassVar[DynamicColor] = ...
    onSurface: typing.ClassVar[DynamicColor] = ...
    onSurfaceInverse: typing.ClassVar[DynamicColor] = ...
    surfaceVariant: typing.ClassVar[DynamicColor] = ...
    onSurfaceVariant: typing.ClassVar[DynamicColor] = ...
    outline: typing.ClassVar[DynamicColor] = ...
    outlineVariant: typing.ClassVar[DynamicColor] = ...
    primaryContainer: typing.ClassVar[DynamicColor] = ...
    onPrimaryContainer: typing.ClassVar[DynamicColor] = ...
    primary: typing.ClassVar[DynamicColor] = ...
    primaryInverse: typing.ClassVar[DynamicColor] = ...
    onPrimary: typing.ClassVar[DynamicColor] = ...
    secondaryContainer: typing.ClassVar[DynamicColor] = ...
    onSecondaryContainer: typing.ClassVar[DynamicColor] = ...
    secondary: typing.ClassVar[DynamicColor] = ...
    onSecondary: typing.ClassVar[DynamicColor] = ...
    tertiaryContainer: typing.ClassVar[DynamicColor] = ...
    onTertiaryContainer: typing.ClassVar[DynamicColor] = ...
    tertiary: typing.ClassVar[DynamicColor] = ...
    onTertiary: typing.ClassVar[DynamicColor] = ...
    errorContainer: typing.ClassVar[DynamicColor] = ...
    onErrorContainer: typing.ClassVar[DynamicColor] = ...
    error: typing.ClassVar[DynamicColor] = ...
    onError: typing.ClassVar[DynamicColor] = ...
    primaryFixed: typing.ClassVar[DynamicColor] = ...
    primaryFixedDarker: typing.ClassVar[DynamicColor] = ...
    onPrimaryFixed: typing.ClassVar[DynamicColor] = ...
    onPrimaryFixedVariant: typing.ClassVar[DynamicColor] = ...
    secondaryFixed: typing.ClassVar[DynamicColor] = ...
    secondaryFixedDarker: typing.ClassVar[DynamicColor] = ...
    onSecondaryFixed: typing.ClassVar[DynamicColor] = ...
    onSecondaryFixedVariant: typing.ClassVar[DynamicColor] = ...
    tertiaryFixed: typing.ClassVar[DynamicColor] = ...
    tertiaryFixedDarker: typing.ClassVar[DynamicColor] = ...
    onTertiaryFixed: typing.ClassVar[DynamicColor] = ...
    onTertiaryFixedVariant: typing.ClassVar[DynamicColor] = ...
    controlActivated: typing.ClassVar[DynamicColor] = ...
    controlNormal: typing.ClassVar[DynamicColor] = ...
    controlHighlight: typing.ClassVar[DynamicColor] = ...
    textPrimaryInverse: typing.ClassVar[DynamicColor] = ...
    textSecondaryAndTertiaryInverse: typing.ClassVar[DynamicColor] = ...
    textPrimaryInverseDisableOnly: typing.ClassVar[DynamicColor] = ...
    textSecondaryAndTertiaryInverseDisabled: typing.ClassVar[DynamicColor] = ...
    textHintInverse: typing.ClassVar[DynamicColor] = ...
    @staticmethod
...
class ToneDeltaConstraint(java.lang.Object):
    delta: float = ...
    keepAway: DynamicColor = ...
    keepAwayPolarity: TonePolarity = ...
    def __init__(self, delta: float | java.jdouble | java.lang.Double, keepAway: DynamicColor, keepAwayPolarity: TonePolarity, /) -> None: ...

class TonePolarity(java.lang.Enum[TonePolarity]):
    DARKER: typing.ClassVar[TonePolarity] = ...
    LIGHTER: typing.ClassVar[TonePolarity] = ...
    NO_PREFERENCE: typing.ClassVar[TonePolarity] = ...
    @staticmethod
