...
class EnumEntriesList(java.io.Serializable, kotlin.collections.AbstractList[_EnumEntriesList__T], EnumEntries[_EnumEntriesList__T], typing.Generic[_EnumEntriesList__T]):
    def __init__(self, entriesProvider: kotlin.jvm.functions.Function0[java.chaquopy.JavaArray[_EnumEntriesList__T]], /) -> None: ...
