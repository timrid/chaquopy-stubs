...
class SequenceBuilderIterator(SequenceScope[_SequenceBuilderIterator__T], java.util.Iterator[_SequenceBuilderIterator__T], kotlin.coroutines.Continuation[kotlin.Unit], kotlin.jvm.internal.markers.KMappedMarker, typing.Generic[_SequenceBuilderIterator__T]):
    ...
    def yieldAll(self, iterator: java.util.Iterator[_SequenceBuilderIterator__T], arg2: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
    def yield_(self, value: _SequenceBuilderIterator__T, arg2: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
...
class SequenceScope(java.lang.Object, typing.Generic[_SequenceScope__T]):
    def __init__(self) -> None: ...
    @typing.overload
    def yieldAll(self, elements: java.lang.Iterable[_SequenceScope__T], arg2: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
    @typing.overload
    ...
    @typing.overload
    def yieldAll(self, sequence: Sequence[_SequenceScope__T], arg2: kotlin.coroutines.Continuation[kotlin.Unit], /) -> java.lang.Object: ...
...
class SequencesKt__SequencesKt(SequencesKt__SequencesJVMKt):
    ...
    @staticmethod
    def ifEmpty(receiver: Sequence[_ifEmpty__T], defaultValue: kotlin.jvm.functions.Function0[Sequence[_ifEmpty__T]], /) -> Sequence[_ifEmpty__T]: ...
...
class SequencesKt___SequencesKt(SequencesKt___SequencesJvmKt):
    ...
    @staticmethod
    def associateWith(receiver: Sequence[_associateWith__K], valueSelector: kotlin.jvm.functions.Function1[_associateWith__K, _associateWith__V], /) -> java.util.Map[_associateWith__K, _associateWith__V]: ...
    _associateWithTo__K = typing.TypeVar('_associateWithTo__K')  # <K>
    _associateWithTo__M = typing.TypeVar('_associateWithTo__M')  # <M>
    @staticmethod
    def associateWithTo(receiver: Sequence[_associateWithTo__K], destination: _associateWithTo__M, valueSelector: kotlin.jvm.functions.Function1[_associateWithTo__K, java.lang.Object], /) -> _associateWithTo__M: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def chunked(receiver: Sequence[_chunked_0__T], size: int | java.jint | java.lang.Integer, /) -> Sequence[java.util.List[_chunked_0__T]]: ...
    @typing.overload
    @staticmethod
    def chunked(receiver: Sequence[_chunked_1__T], size: int | java.jint | java.lang.Integer, transform: kotlin.jvm.functions.Function1[java.util.List[_chunked_1__T], _chunked_1__R], /) -> Sequence[_chunked_1__R]: ...
    ...
    @staticmethod
    def groupingBy(receiver: Sequence[_groupingBy__T], keySelector: kotlin.jvm.functions.Function1[_groupingBy__T, _groupingBy__K], /) -> kotlin.collections.Grouping[_groupingBy__T, _groupingBy__K]: ...
    ...
    @typing.overload
    @staticmethod
    def max(receiver: Sequence[_max_0__T], /) -> _max_0__T: ...
    @typing.overload
    @staticmethod
    def max(receiver: Sequence[java.lang.Double], /) -> float: ...
    @typing.overload
    @staticmethod
    def max(receiver: Sequence[java.lang.Float], /) -> float: ...
    ...
    @typing.overload
    @staticmethod
    def min(receiver: Sequence[_min_0__T], /) -> _min_0__T: ...
    @typing.overload
    @staticmethod
    def min(receiver: Sequence[java.lang.Double], /) -> float: ...
    @typing.overload
    @staticmethod
    def min(receiver: Sequence[java.lang.Float], /) -> float: ...
    ...
    @staticmethod
    def onEach(receiver: Sequence[_onEach__T], action: kotlin.jvm.functions.Function1[_onEach__T, kotlin.Unit], /) -> Sequence[_onEach__T]: ...
    ...
    @typing.overload
    @staticmethod
    def windowed(receiver: Sequence[_windowed_0__T], size: int | java.jint | java.lang.Integer, step: int | java.jint | java.lang.Integer, partialWindows: bool | java.jboolean | java.lang.Boolean, /) -> Sequence[java.util.List[_windowed_0__T]]: ...
    @typing.overload
    @staticmethod
    def windowed(receiver: Sequence[_windowed_1__T], size: int | java.jint | java.lang.Integer, step: int | java.jint | java.lang.Integer, partialWindows: bool | java.jboolean | java.lang.Boolean, transform: kotlin.jvm.functions.Function1[java.util.List[_windowed_1__T], _windowed_1__R], /) -> Sequence[_windowed_1__R]: ...
    ...
    @typing.overload
    @staticmethod
    def zipWithNext(receiver: Sequence[_zipWithNext_0__T], /) -> Sequence[kotlin.Pair[_zipWithNext_0__T, _zipWithNext_0__T]]: ...
    @typing.overload
    @staticmethod
    def zipWithNext(receiver: Sequence[_zipWithNext_1__T], transform: kotlin.jvm.functions.Function2[_zipWithNext_1__T, _zipWithNext_1__T, _zipWithNext_1__R], /) -> Sequence[_zipWithNext_1__R]: ...
