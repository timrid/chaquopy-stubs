...
class Mercator(org.osmdroid.views.util.constants.MapViewConstants):
    ...
    @typing.overload
    @staticmethod
    def projectGeoPoint(pGeoPoint: org.osmdroid.api.IGeoPoint, pZoom: int | java.jint | java.lang.Integer, pUseAsReturnValue: android.graphics.Point, /) -> android.graphics.Point: ...
    @typing.overload
    @staticmethod
    def projectGeoPoint(aLat: float | java.jdouble | java.lang.Double, aLon: float | java.jdouble | java.lang.Double, aZoom: int | java.jint | java.lang.Integer, aUseAsReturnValue: android.graphics.Point, /) -> android.graphics.Point: ...
    @typing.overload
    @staticmethod
    def projectGeoPoint(aLatE6: int | java.jint | java.lang.Integer, aLonE6: int | java.jint | java.lang.Integer, aZoom: int | java.jint | java.lang.Integer, reuse: android.graphics.Point, /) -> android.graphics.Point: ...
    @staticmethod
...
class PathProjection(java.lang.Object):
    ...
    @typing.overload
    @staticmethod
    def toPixels(projection: org.osmdroid.views.MapView.Projection, in_: java.util.List[org.osmdroid.util.GeoPoint], reuse: android.graphics.Path, /) -> android.graphics.Path: ...
    @typing.overload
    @staticmethod
    def toPixels(projection: org.osmdroid.views.MapView.Projection, in_: java.util.List[org.osmdroid.util.GeoPoint], reuse: android.graphics.Path, doGudermann: bool | java.jboolean | java.lang.Boolean, /) -> android.graphics.Path: ...
