...
Python type stubs for [`org.osmdroid:osmdroid-android:5.0.1`](https://mvnrepository.com/artifact/org.osmdroid/osmdroid-android/5.0.1), generated with [chaquopy-stubgen](https://github.com/chaquo/chaquopy) `0.2.1`.
...
```bash
pip install chaquopy-stubs-org-osmdroid-osmdroid-android==5.0.1
```