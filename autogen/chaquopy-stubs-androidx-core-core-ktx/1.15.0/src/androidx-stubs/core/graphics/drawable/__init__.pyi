...
class DrawableKt(java.lang.Object):
    ...
    @staticmethod
    def toBitmapOrNull(this_toBitmapOrNull: android.graphics.drawable.Drawable, width: int | java.jint | java.lang.Integer, height: int | java.jint | java.lang.Integer, config: android.graphics.Bitmap.Config, /) -> android.graphics.Bitmap: ...
    @staticmethod
