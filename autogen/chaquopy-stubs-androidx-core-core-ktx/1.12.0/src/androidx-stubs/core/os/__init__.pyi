...
class BundleApi18ImplKt(java.lang.Object):
    INSTANCE: typing.ClassVar[BundleApi18ImplKt] = ...
    @staticmethod
    def putBinder(bundle: android.os.Bundle, key: str | java.lang.String, value: android.os.IBinder, /) -> None: ...
...
class ContinuationOutcomeReceiver(android.os.OutcomeReceiver[_ContinuationOutcomeReceiver__R, _ContinuationOutcomeReceiver__E], java.util.concurrent.atomic.AtomicBoolean, typing.Generic[_ContinuationOutcomeReceiver__R, _ContinuationOutcomeReceiver__E]):
