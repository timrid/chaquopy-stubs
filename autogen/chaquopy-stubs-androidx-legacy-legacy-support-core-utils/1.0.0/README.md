...
These are stub-only packages ([PEP 561](https://peps.python.org/pep-0561/)). Install them alongside your project to get type checking support for `androidx.legacy:legacy-support-core-utils:1.0.0` when using [Chaquopy](https://github.com/chaquo/chaquopy).
